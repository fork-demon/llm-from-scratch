...
3. Delete every sentence containing "dog" from the corpus and retrain. Where does "dog" end up? (Its row still exists — it just never got nudged.) Now write one sentence about why LLMs are unreliable about things that are rare in their training data. You've just demonstrated the root cause of half of module 10.
