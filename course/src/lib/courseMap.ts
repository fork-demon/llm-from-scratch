...
export const COURSE_MAP: MapNode[] = [
  ...
  { id: 'training', label: 'Training', question: 'What actually happens during “training”, and how does a text predictor become an assistant?', build: 'You train your GPT on Shakespeare and watch loss fall and samples improve.', lessons: ['training-gpt', 'training-pipeline', 'distillation', 'alignment-safety'] },
  ...
  { id: 'llm', label: 'LLM', question: 'What separates your tiny GPT from a modern LLM, where does its knowledge live, and can we read it?', build: 'You read a modern architecture with the eyes of someone who built the small one, turn an image into tokens, and watch features pack into superposition.', lessons: ['why-llms-know', 'modern-architecture', 'multimodal', 'interpretability'] },
