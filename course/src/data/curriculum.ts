...
export const PARTS: PartMeta[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'distillation', title: 'Small models from big ones', question: 'How does a 3-billion-parameter model learn from a 600-billion-parameter one?', minutes: 20, here: 'training' },
      { id: 'alignment-safety', title: 'Alignment and safety', question: 'How do you teach a model what it should not do, and how do you check that it learned?', minutes: 25, here: 'training' },
      { id: 'multimodal', title: 'Models that see and hear', question: 'How does a model that only reads tokens look at a photo?', minutes: 22, here: 'tokenizer' },
      { id: 'interpretability', title: 'Looking inside the model', question: 'Can we read what the numbers inside a model mean?', minutes: 25, here: 'block' },
