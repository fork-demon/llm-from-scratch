...
export const PARTS: PartMeta[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'interpretability', title: 'Looking inside the model', question: 'Can we read what the numbers inside a model mean?', minutes: 50, here: 'block' },
      { id: 'reasoning-models', title: 'Reasoning models', question: 'What changes when a model is allowed to think before answering?', minutes: 60, here: 'sampling', notes: 'appendix-frontier-topics.md' },
    ],
  },
  {
    id: 'systems',
    ...
    lessons: [
      { id: 'rag', title: 'Retrieval-augmented generation', question: 'What if the information is not inside the model?', minutes: 55, here: 'rag', sources: [{ path: 'phase4-modern-llms/vector_db.py', note: 'a vector database: exact search, IVF index, quantization' }, { path: 'phase4-modern-llms/mini_rag.py', note: 'the full pipeline: chunk, embed, retrieve, prompt, answer' }], notes: 'phase4-modern-llms/12-rag.md' },
      { id: 'fine-tuning', title: 'Fine-tuning', question: 'What does fine-tuning change that a prompt cannot?', minutes: 55, here: 'finetune', sources: [{ path: 'phase4-modern-llms/finetune_tiny_gpt.py', note: 'full fine-tune vs LoRA, with catastrophic forgetting measured' }], notes: 'phase4-modern-llms/13-fine-tuning.md' },
  ...
  },
  {
    ...
    lessons: [
      { id: 'evals', title: 'Evals: how you know it works', question: 'The demo looked great. How do you know the system actually works?', minutes: 55, here: 'around', sources: [{ path: 'phase6-engineering/eval_harness.py', note: 'a golden set, three scoring methods and bootstrap confidence intervals, run against mini_rag.py' }] },
      ...
      { id: 'making-models-cheaper', title: 'Making the model itself cheaper', question: 'The batch is as full as it can get. What is left to change?', minutes: 60, here: 'sampling', sources: [{ path: 'phase6-engineering/quantize_demo.py', note: 'int8 and int4 weight quantization in NumPy, with the error measured' }, { path: 'phase6-engineering/speculative_demo.py', note: 'speculative decoding on toy distributions, with the output proven equal to the target model’s' }] },
