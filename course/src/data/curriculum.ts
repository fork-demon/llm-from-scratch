...
export const PARTS: PartMeta[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'inference-systems', title: 'Inference systems: serving LLMs', question: 'One user is easy. What changes when a thousand arrive at once?', minutes: 40, here: 'sampling', sources: [{ path: 'phase6-engineering/batching_sim.py', note: 'static versus continuous batching, simulated request by request' }, { path: 'phase6-engineering/quantize_demo.py', note: 'int8 and int4 weight quantization in NumPy, with the error measured' }, { path: 'phase6-engineering/speculative_demo.py', note: 'speculative decoding on toy distributions, with the output proven equal to the target model’s' }] },
